...
var ManufacturerService = (function () {
    function ManufacturerService() {
        this.manufacturers = [
            { id: 1, cssClassName: 'americanStandard', name: 'American Standard', statesRepresented: 'OK', blurb: 'For over 140 years, American Standard has led the way in developing innovative bathroom and kitchen products including high performance toilets, stylish faucets, and wellness products that have set and re-set the standards for living healthy, living responsibly, and living beautifully.', image: 'AmericanStandardLogoLight.png' },
